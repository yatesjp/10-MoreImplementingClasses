...
class CapitalT(object):
    ...
    def clone(self):
        ...
        Marty = CapitalT(self.h_rect.get_center(), self.h_rect.get_width(), self.v_rect.get_height(), self.v_rect.get_width())
        Marty.set_colors(self.h_rect.fill_color, self.v_rect.outline_color)
        return Marty
